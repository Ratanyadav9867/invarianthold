...
def decode_access_token(token: str) -> Dict[str, Any]:
    """
    Cryptographically verify and decode access token.
    Raises HTTPException 401 on expired, invalid, unsigned, or malformed tokens.
    """
    ...
    # Disallow 'none' or unsigned algorithms
    try:
